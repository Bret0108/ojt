<?php
  include('PHP/StudentTeacher.php')
...
<html lang="en">
  ...
  <body>
    ...
    <div id="mySidenav" class="sidenav">
      <a href="../Logout.php" id="Home"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"   fill="currentColor" class="bi bi-arrow-left-circle" viewBox="0 0 16 16">
