  ...
  <body>
    ...
    <div class="container hakdog">
     ...
     <div id="mySidenav" class="sidenav">
      <a href="Bypass_UserCheck.php" id="Home"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-arrow-left-circle" viewBox="0 0 16 16">
    ...
    <div class="containered">
      ...
      <form action=" " method="POST" >
        ...
        <div class="row">
          ...
          <div class="col-75">
            <input class="form-control" type="text" id="ReqName" value="" name="ReqName" placeholder="Name" required>
          </div>
        </div>
        <div class="row">
          <div class="col-25">
