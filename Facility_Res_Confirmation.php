...
<html lang="en">
  ...
  <body>
    ...
    <div class="containered">
        ...
        <div class="table-responsive">
            <table class = "table table-bordered">
                <thead>
                  ...
                  <tbody>
                      <?php include('PHP/FacilityRes/ViewReservationF.php');?>
                  </tbody>
                  </tr>
                </thead>
            </table>
        ...
        <?php include('PHP/FacilityRes/Confirm_ResF.php'); ?>
      </div>
    <a class='btn btn-danger'  href='Facility_Reservation.php? id="<?= $row['Res_id'];?>"'>Cancel</a>
    <a class='btn btn-success' href='Facility_Res_Confirmation.php? name="<?= $row['Res_id'];?>"'>Confirm</a>
