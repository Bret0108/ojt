...
<html lang="en">
  ...
  <body>
    ...
    <div id="cons">
    <a class='btn btn-danger'  href='Equipment_Reservation.php? id="<?= $row['Res_id'];?>"'>Cancel</a>
    <a class='btn btn-success' href='Equip_Res_Confirmation.php? name="<?= $row['Res_id'];?>"'>Confirm
    </a>
    </div>
