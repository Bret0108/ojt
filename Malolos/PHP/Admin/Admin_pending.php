					...
					?>
						<tr>
							<td>
						    	...
						    	<a class='btn btn-danger' Style="margin-top:10px; Width:100px"  href='Admin_home.php? id="<?= $row['Res_id'];?>"'>Cancel</a>
							</td>
			...
			if(mysqli_num_rows($run1) > 0){
				foreach($run1 as $row1){
					...
					?>
						<tr>
							<td>
								<a class='btn btn-success' href='Admin_home.php? id="<?= $row1['Res_id'];?>"'>Confirm</a>
